...
?>
<div>
<tr><td> No Registrasi</td><td><input type='text' name='no_registrasi' value='<?php echo $_GET['nodaftar'];?>' disabled></td></tr> 
<tr><td> Nama Lengkap</td><td><input type='text' name='nm_lengkap' value='<?php echo $r['nama_lengkap'];?>' ></td></tr> 
...
?>	
<tr><td> Tempat / Tanggal Lahir </td><td><input name="tmpt_lhir" value='<?php echo $r['tmp_lahir'];?>' type="text"  maxlength="35"/> /
					<?php
						...
						echo "</select>";
						$nama_bln=array($no=1>"Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember");
						echo "<select name=bulan><option value=$vbln>$vnm_bln[$vbln]</option>";
							for($no=1;$no<=12;$no++)
							{
...
<tr><td> Alamat</td><td><input type='text' size='54' value='<?php echo $r['alamat'];?>' name='alamat'></td></tr> 
<tr><td> Tamatan</td><td><input type='text' value='<?php echo $r['tamatan'];?>' name='tamatan'></td></tr> 
<tr><td> Jurusan</td><td><input type='text' value='<?php echo $r['jurusan'];?>' name='jurusan'></td></tr> 
<tr><td> IPK </td><td><input type='text' size='4' maxlength='4' value='<?php echo $r['ipk'];?>' name='ipk'></td></tr>   
