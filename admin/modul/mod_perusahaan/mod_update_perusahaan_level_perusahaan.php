...
?>
<div class="content_title_01">&#187; Edit Akun Perusahaan</div>
...
<tr><td>Nama Perusahaan</td>     <td> : <input type=text name='nama' size='50' value='<?php echo $r['nama_p'];?>' required></td></tr>
          <tr><td>Alamat</td>     <td> : <input type=text name='alamat' size='50' value='<?php echo $r['alamat'];?>' required></td></tr>
          <tr><td>Wilayah</td>     <td> : 	<select name='wilayah' style='width: 146px;' required>
											...
											<option value='Surya Cipta'>Surya Cipta</option>
											</select></td></tr>
          <tr><td>E-mail</td>       <td> : <input type=text name='email' value='<?php echo $r['email'];?>' size=30 required></td></tr>
          <tr><td>Telepon</td>       <td> : <input type=text name='tlp' value='<?php echo $r['tlp'];?>' size=30 required></td></tr>
