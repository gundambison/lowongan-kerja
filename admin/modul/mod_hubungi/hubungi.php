...
switch($_GET['act']){
  ...
  default:
    ...
    while ($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td>$no</td>
                ...
                <td>$r[subjek]</td>
                <td>$tgl</a></td>
                <td><a href=$aksi?module=hubungi&act=hapus&id=$r[id_hubungi] onclick='return confirm('Anda yakin ingin menghapus data ini ?')'>Hapus</a>
                </td></tr>";
    $no++;
    }
    echo "</table>";
  ...
  case "kirimemail":
    ...
    echo "<h2>Status Email</h2>
          <p>Email telah sukses terkirim ke tujuan erereryrtyrty</p>
